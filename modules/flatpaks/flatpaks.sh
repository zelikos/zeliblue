...
cp -r "$CONFIG_DIRECTORY/modules/usr/bin/system-flatpak-setup" "/usr/bin/system-flatpak-setup"
cp -r "$CONFIG_DIRECTORY/modules/usr/bin/user-flatpak-setup" "/usr/bin/user-flatpak-setup"
